...
const TaskModal = ({isOpen, onClose, taskToEdit, onSave, onLogout}) => {
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center 
        justify-center p-4">
            <div className="bg-white border border-purple-100 rounded-xl max-w-md
            w-full shadow-lg relative p-6 animate-fadeIn">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            ...
                            className={baseControlClasses} placeholder="Add task details" />
                    </div>
